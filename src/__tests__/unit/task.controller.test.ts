...
describe("TaskController", () => {
	beforeEach(() => {
		vi.clearAllMocks();
		// Silence expected error logs from the 500 branches
	...
	describe("createTask", () => {
		...
		it("should return 400 when title is an empty/whitespace string", async () => {
	...
	describe("updateTask", () => {
		...
		it("should return 404 when the service reports the task is missing", async () => {
